...
void input(){
	...
	if(n==0) { printf("\n No queries\n"); }
		...
		printf("\nEnter 0 for faculty and 1 for student\n");
		for(i=0; i<n; i++){
			printf("\nJob Type (0/1): "); scanf("%d", &map);
			if(map==1){
...
void inst(){
	printf("\nWelcome to Linux Expert Mr. Sudesh Sharma  Query session, please follow these instruction for proper functioning of the program"
			"\n**>Enter time in 2400 hours format. example 1000 for 10:00"
